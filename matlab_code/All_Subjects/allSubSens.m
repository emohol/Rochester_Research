...
%     avg_sens_10 = [];
    ...
    for i=1:length(ecc_levels)
        ...
        avg_sens_10(si).sens1(i) = sens(1);
        avg_sens_10(si).pres2(i) = 500;
        avg_sens_10(si).sens2(i) = sens(2);
...
%                     'DisplayName',['Sub - A013,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'s','linewidth', 2,'Color','k','MarkerEdgeColor','k','MarkerSize', 15,...
                    'DisplayName',['Sub - A013,','Ecc - ',num2str(ecc_levels(i))])
                hold on
            elseif ecc_levels(i)==4
%                 errorbar([50 500],sens,stddev,'s','linewidth', 2,'Color','r','MarkerEdgeColor','r','MarkerSize', 15,...
%                     'DisplayName',['Sub - A013,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'s','linewidth', 2,'Color','r','MarkerEdgeColor','r','MarkerSize', 15,...
                    'DisplayName',['Sub - A013,','Ecc - ',num2str(ecc_levels(i))])
                hold on
            elseif ecc_levels(i)==8
%                 errorbar([50 500],sens,stddev,'s','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
%                     'DisplayName',['Sub - A013,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'s','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
                    'DisplayName',['Sub - A013,','Ecc - ',num2str(ecc_levels(i))])
                hold on
...
%                     'DisplayName',['Sub - Nikunj,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'v','linewidth', 2,'Color','k','MarkerEdgeColor','k','MarkerSize', 15,...
                    'DisplayName',['Sub - Nikunj,','Ecc - ',num2str(ecc_levels(i))])
                hold on
            elseif ecc_levels(i)==4
%                 errorbar([50 500],sens,stddev,'v','linewidth', 2,'Color','r','MarkerEdgeColor','r','MarkerSize', 15,...
%                     'DisplayName',['Sub - Nikunj,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'v','linewidth', 2,'Color','r','MarkerEdgeColor','r','MarkerSize', 15,...
                    'DisplayName',['Sub - Nikunj,','Ecc - ',num2str(ecc_levels(i))])
                hold on
            elseif ecc_levels(i)==8
%                 errorbar([50 500],sens,stddev,'v','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
%                     'DisplayName',['Sub - Nikunj,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'v','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
                    'DisplayName',['Sub - Nikunj,','Ecc - ',num2str(ecc_levels(i))])
                hold on
...
%                     'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'o','linewidth', 2,'Color','k','MarkerEdgeColor','k','MarkerSize', 15,...
                    'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                hold on
            elseif ecc_levels(i)==4
%                 errorbar([50 500],sens,stddev,'o','linewidth', 2,'Color','r','MarkerEdgeColor','r','MarkerSize', 15,...
%                     'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'o','linewidth', 2,'Color','r','MarkerEdgeColor','r','MarkerSize', 15,...
                    'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                hold on
            elseif ecc_levels(i)==8
%                 errorbar([50 500],sens,stddev,'o','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
%                     'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'o','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
                    'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                hold on
...
%                     'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'x','linewidth', 2,'Color','k','MarkerEdgeColor','k','MarkerSize', 15,...
...
%                     'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'x','linewidth', 2,'Color','r','MarkerEdgeColor','r','MarkerSize', 15,...
                    'DisplayName',['Sub - A036,','Ecc - ',num2str(ecc_levels(i))])
                hold on
            elseif ecc_levels(i)==8
%                 errorbar([50 500],sens,stddev,'x','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
%                     'DisplayName',['Sub - A092,','Ecc - ',num2str(ecc_levels(i))])
                plot([50 500],sens,'x','linewidth', 2,'Color','b','MarkerEdgeColor','b','MarkerSize', 15,...
                    'DisplayName',['Sub - A036,','Ecc - ',num2str(ecc_levels(i))])
                hold on
...
%         if std1==0
        ...
        avg_sens_2(si).sens1(i) = sens(1);
        avg_sens_2(si).pres2(i) = 500;
        avg_sens_2(si).sens2(i) = sens(2);
        %             if sens>0.5
        %                 sens = 0.5;
        %             elseif sens<0
        %                 sens = 0;
...
ylabel('Sensitivity')
title('High SpFreq')
saveas(figure(2),[fig_path '\Sens_Pres_10'],'epsc');
hold off
...
ylabel('Sensitivity')
title('Low SpFreq')
saveas(figure(1),[fig_path '\Sens_Pres_2'],'epsc');