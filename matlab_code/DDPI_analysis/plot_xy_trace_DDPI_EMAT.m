...
pathtodata = 'C:\Users\Ruccilab\Box\Vis_Dynamics\Data\DDPI\Nikunj';
...
%     subplot(2,1,1);
    ...
    EMAT_saccOn = EMAT_saccOn*(1000/sRate);
    EMAT_saccOff = EMAT_saccOff*(1000/sRate);
    ...
    EMAT_driftOn = EMAT_driftOn*(1000/sRate);
    EMAT_driftOff = EMAT_driftOff*(1000/sRate);
